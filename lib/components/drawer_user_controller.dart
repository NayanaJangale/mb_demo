...
import 'package:softcoremobilebanking/components/home_drawer.dart';
...
class DrawerUserController extends StatefulWidget {
  ...
  final Function(Menu) onDrawerCall;
                  ...
                  builder: (BuildContext context, Widget child) {
                    return Transform(
                      ...
                      child: HomeDrawer(
                        ...
                        menuLen: widget.menuLen,
                        callBackIndex: (Menu menu) {
                          onDrawerClick();
                          try {
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(color:Theme.of(context).primaryColor.withOpacity(0.6), blurRadius: 24),
                    ],
                  ),
                  child: Stack(
                    children: <Widget>[
