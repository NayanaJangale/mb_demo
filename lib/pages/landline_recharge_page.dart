...
class _LandlineRechargePageState extends State<LandlineRechargePage> {
  ...
  String _loadingText, selectedAccountType;
  final GlobalKey<ScaffoldState> landlineRechargeScaffoldKey =
      new GlobalKey<ScaffoldState>();

  TextEditingController amoutAccCntl = TextEditingController();
  TextEditingController landlineNoAccCntl = TextEditingController();
  TextEditingController accountNoAccCntl = TextEditingController();

  FocusNode amoutFcsNode = FocusNode();
  FocusNode landlineNoFcsNode = FocusNode();
  FocusNode accountNoFcsNode = FocusNode();
  List<Account> accountList = [];
  Account selectedAc;
  List<String> accountType = ['Individual', 'Co-Operate'];
  ...
  Future<void> initState() {
    ...
    if (widget.menuType != MenuTypeConst.Cyberplat) {
      loadCricleCode(serviceID: "%");
    }
    if (widget.accountType != null && widget.accountType != "") {
      selectedAccountType = accountType
          .where((i) => i.toLowerCase() == widget.accountType.toLowerCase())
          .first;
    }
    if (widget.subscriberNo != null && widget.subscriberNo != "") {
      landlineNoAccCntl.text = widget.subscriberNo;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return CustomProgressHandler(
      ...
      child: Container(
        ...
        child: SafeArea(
          child: Scaffold(
            key: landlineRechargeScaffoldKey,
            body: Column(
              children: [
                Expanded(
                        ...
                        CustomAppbar(
                          ...
                          onIconPressed: () async {
                            ...
                            if (connectionServerMsg != "key_check_internet") {
                              String url;
                              if (widget.menuType == MenuTypeConst.Cyberplat) {
                                url =connectionServerMsg + "/CustCommonAppApi/help/CyberplatLandline.pdf";
                              }else if (widget.menuType == MenuTypeConst.Pay2New) {
                                url =connectionServerMsg + "/CustCommonAppApi/help/Pay2NewLandline.pdf";
                              }
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        CustomTextField(
                                          ...
                                          autofoucus: false,
                                          isIcon: false,
                                          textEditingController: landlineNoAccCntl,
                                          focusNode: landlineNoFcsNode,
                                          borderRadius: 10,
                                          onFieldSubmitted: (value) {
                                            this.landlineNoFcsNode.unfocus();
                                          },
                                          icon: Icons.monetization_on_outlined,
                                          hint: AppTranslations.of(context)
                                              .text("key_landline_no"),
                                        ),
                                        SizedBox(
                                          height: 10.0,
                                        ),
                                        ...
                                        Visibility(
                                          ...
                                          child: CustomTextField(
                                            ...
                                            autofoucus: false,
                                            isIcon: false,
                                            textEditingController: accountNoAccCntl,
                                            focusNode: accountNoFcsNode,
                                            borderRadius: 10,
                                            onFieldSubmitted: (value) {
                                              this.accountNoFcsNode.unfocus();
                                            },
                                            icon: Icons.monetization_on_outlined,
                                            hint: AppTranslations.of(context)
                                                .text("key_account_no"),
                                ...
                                Navigator.pushReplacement(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) => OTPVerificationPage(
                                        ...
                                        subscriberNo:
                                            landlineNoAccCntl.text.toString(),
                                        ...
                                        billingUnitNo:
                                            accountNoAccCntl.text.toString(),
                                        Authenticator3:
  ...
  Future<void> showAccountTypeList() async {
    showCupertinoModalPopup(
      context: context,
      builder: (BuildContext context) => CupertinoActionSheet(
        message: CustomCupertinoActionMessage(
          message: AppTranslations.of(context).text("key_account_type"),
        ),
        actions: List<Widget>.generate(
          accountType.length,
          (i) => CustomCupertinoAction(
            actionText: accountType[i],
            actionIndex: i,
            onActionPressed: () {
              setState(() {
          ...
          try {
            ...
            if (widget.operatorCode != null && widget.operatorCode != "") {
              selectedOperator = operatorList
                  ...
                  .first;
              if (widget.menuType == MenuTypeConst.Cyberplat) {
                loadCricleCode(serviceID: selectedOperator.OpCode.toString());
              }
            }
          } catch (e) {
            print(e);
  ...
  void loadCricleCode({String serviceID}) {
    BBPSAPI(context: this.context)
