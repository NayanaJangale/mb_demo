...
class _LoginPageState extends State<LoginPage>
  ...
  Future<void> initState() {
   ...
   /* setState(() {
      custIDController.text = '0000024660';
      passwordController.text = '722827';
      bankCodeController.text = '1010';
    });*/
    banner64Str =
              ...
              child: Container(
                ...
                child: bytesBannerImg == null
                  ...
                  fit: BoxFit.fitWidth,
                    ...
                    : Image.memory(bytesBannerImg),
              ),
            ),
            AnimatedPositioned(
              duration: Duration(milliseconds: 700),
              curve: Curves.bounceInOut,
              top: isLoginByCustID ? 160 : 170,
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                Text(
                                    AppTranslations.of(context).text("key_pin"),
        ...
        children: [
          ...
          PinInputTextFormField(
            ...
            decoration: BoxLooseDecoration(
              ...
              bgColorBuilder: true
                  ? PinListenColorBuilder(Colors.white.withOpacity(0.5),
              ...
              if (valMsg == '') {
                ...
                CustomerAPI(context: context)
                  ...
                  if (res != null && HttpStatusCodes.CREATED == res['Status']) {
                    ...
                    if (customerLogin != null && customerLogin.user != null) {
                      if (customerLogin.user.ChangeLoginPasswordOnNextLogin) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ChangePasswordPage(
                                transactionType:
                                    TransactionType.ChangeCustomerPassword),
                          ),
                        );
                      } else {
                        Navigator.push(
